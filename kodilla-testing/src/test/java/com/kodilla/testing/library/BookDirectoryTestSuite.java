...
public class BookDirectoryTestSuite {
    ...
    //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user0 = new LibraryUser("Stefan", "Pracz", "987654321");
        LibraryUser user1 = new LibraryUser("Ala", "Kota", "98765432");
        LibraryUser user5 = new LibraryUser("Mam", "5", "389590954");
    ...
    //When
        List<Book> theListOf0Books0 = bookLibrary.listBooksInHandsOf(user0);
        List<Book> theListOf0Books1 = bookLibrary.listBooksInHandsOf(user1);
        List<Book> theListOf0Books5 = bookLibrary.listBooksInHandsOf(user5);

    //Then
        assertEquals(0, theListOf0Books0.size());
        assertEquals(1, theListOf0Books1.size());
        assertEquals(5, theListOf0Books5.size());
